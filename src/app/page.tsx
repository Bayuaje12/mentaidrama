...
export default function HomePage() {
  ...
  // false = WEB LIVE | true = WEB TERKUNCI
      ...
      <main className="fixed inset-0 z-[10000] flex flex-col items-center justify-center bg-black p-6">
        ...
        <div className="text-center space-y-5">
          ...
          <p className="text-white/30 text-[10px] uppercase tracking-[0.5em] max-w-xs mx-auto leading-relaxed">
            Sedang ditingkatkan untuk pengalaman yang lebih cepat.
          </p>
          <div className="pt-8">
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      {/* --- LAYER 1: SPLASH SCREEN (Z-INDEX 10000) --- */}
      {loading && (
        ...
        <header className="fixed top-0 left-0 right-0 z-[500] bg-black/80 backdrop-blur-xl border-b border-white/5 px-4 py-4">
          <div className="flex items-center justify-between gap-4 max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-3">
              <div className="relative w-9 h-9 border border-primary/20 rounded-xl p-1.5 bg-[#0c0c0c]">
                <Image src="/favicon.ico" alt="Logo" fill className="object-contain" />
              </div>
              <div>
            ...
            {/* Tombol Search yang sudah diperbaiki aksesibilitasnya */}
            <div className="relative z-[501]">
              <button 
                type="button"
                className="p-2.5 bg-white/5 rounded-full border border-white/10 text-white/40 hover:text-white hover:bg-white/10 active:scale-90 transition-all cursor-pointer pointer-events-auto shadow-lg"
              >
      ...
      {/* --- LAYER 3: KONTEN UTAMA (Z-INDEX 10) --- */}
      ...
      {/* --- LAYER 4: MODAL DONASI (Z-INDEX 9999) --- */}
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/95 backdrop-blur-xl p-6 animate-in fade-in zoom-in duration-500">
          <div className="bg-[#0c0c0c] border border-white/5 p-8 rounded-[3.5rem] max-w-sm w-full text-center relative shadow-[0_0_100px_rgba(0,0,0,1)]">
            ...
            <button 
              ...
              className="absolute -top-3 -right-3 bg-primary text-black hover:bg-white font-black text-[10px] px-4 py-2 rounded-full uppercase tracking-widest z-[10000] cursor-pointer shadow-glow-sm"
            >
              Skip ✕
            </button>
            ...
            <div className="relative z-10">
              ...
              <button
                ...
                className={`w-full py-5 rounded-2xl font-black uppercase tracking-[0.3em] text-[11px] transition-all duration-500 ${
                  ...
                  : "bg-primary text-black shadow-glow-sm hover:bg-white active:scale-95"
                }`}
              >
